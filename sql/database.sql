...
CREATE TABLE MetodosPago (
    ...
    numeroTarjetaEncriptado NCHAR(32) NOT NULL,
    numeroTarjetaHasheado NCHAR(60) NOT NULL,
    vectorInicializacion NCHAR(24) NOT NULL,
    etiquetaAutenticacion NCHAR(32) NOT NULL,
