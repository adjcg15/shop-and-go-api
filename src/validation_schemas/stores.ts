...
const updateStoreValidationSchema: Schema = {
    ...
    address: {
        ...
        isLength:{
            options: { max: 255 },
            errorMessage: "Body value address must have a maximum length of 255 characters"
        },
    },
    openingTime: {
        in: ["body"],
        ...
        matches: {
            ...
            errorMessage: "Body value openingTime must be an hour in format 00:00:00",
        }
    },
    closingTime: {
        in: ["body"],
    ...
    latitude: {
        ...
        isFloat: {
            ...
            errorMessage: "Body value latitude must be a numeric  value between -90 and 90",
        },
        toFloat: true
    },
    longitude: {
        ...
        isFloat: {
            ...
            errorMessage: "Body value longitude must be a numeric  value between -180 and 180",
        },
        toFloat: true
    }
};
