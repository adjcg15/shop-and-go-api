...
async function insertE2EGetProductsByStoreTestData() {
    ...
    const products = await db.Product.bulkCreate([
        {
            ...
            description: "Un vaso de leche entera Lala es la opción que tú y tu familia necesitan para llenarse de energía cada mañana, ya que está adicionada con vitaminas A y D, proteínas y calcio, además es deliciosa y cremosa.", 
            imageUrl: "https://res.cloudinary.com/dblao5461/image/upload/v1735094047/shopandgo/isgwf9wysh8yektgxgw5.webp", 
            salePrice: 32, 
            maximumAmount: 10, 
            isActive: true, 
        ...
        },
        {
            ...
            description: "Ya no tienes que sacrificar el sabor de la leche dentro de tu dieta, balancea tu alimentación con un vaso de leche deslactosada Lala en cada desayuno. Aprovecha los beneficios de la leche sin lactosa.", 
            imageUrl: "https://res.cloudinary.com/dblao5461/image/upload/v1735094116/shopandgo/xxkpmstqlfdu6mspdrtr.webp", 
            salePrice: 34, 
            maximumAmount: 10, 
            isActive: true, 
            idCategory: dairyCategory.id
        },
        {
            ...
            description: "Ya no tienes que sacrificar el rico sabor de la leche que tanto te gusta, disfruta de una excelente opción sin lactosa para cuidar de tu cuerpo y figura, manteniendo una mejor alimentación. Aprovecha nuestra entrega a domicilio y haz tu despensa en línea encontrando este y muchos productos más. *Una opción para ayudar a disminuir la incomodidad digestiva provocada por la lactosa.", 
            imageUrl: "https://res.cloudinary.com/dblao5461/image/upload/v1735170982/shopandgo/mzspjqld0ac6uk8fbegu.jpg", 
            salePrice: 177.1, 
            maximumAmount: 3, 
            isActive: false, 
            idCategory: dairyCategory.id
        },
        {
            ...
            description: "El Yoghurt Yoplait Griego batido sin azúcar Natural 1 kg, es lo mejor que puedes comer para calmar un antojo o para complementar tu desayuno. Gracias a su empaque, es muy fácil de disfrutar, solo destapa, toma tu cuchara y a disfrutar.", 
            imageUrl: "https://res.cloudinary.com/dblao5461/image/upload/v1735171484/shopandgo/jehbxhn0yrot5eatw5gp.jpg", 
            salePrice: 108, 
            maximumAmount: 7, 
            isActive: true, 
            idCategory: dairyCategory.id
        },
        {
            ...
            description: "¡Descubre, Nuestro Atún clásico adquiérelo desde la comodidad de tu hogar! Contiene proteínas, ayuda a proteger tu corazón y figura es la opción perfecta para una alimentación saludable, puedes disfrutarlo en desayunos, comidas o cenas, llévalo siempre contigo y no requiere refrigeración", 
            imageUrl: "https://res.cloudinary.com/dblao5461/image/upload/v1735145876/shopandgo/j6oxvocvqmkref7fpn04.webp", 
            salePrice: 22, 
            maximumAmount: 20, 
            isActive: true, 
        ...
        },
        {
            ...
            description: "Disfruta de los chiles chipotles adobados con tus comidas, prepara ricas y rápidas recetas en solo unos minutos y aporta ese delicioso sabor picante, ideales para estar siempre en tu alacena.", 
            imageUrl: "https://res.cloudinary.com/dblao5461/image/upload/v1735145876/shopandgo/mtjjuywlaszqvldi9yq3.webp", 
            salePrice: 34.5, 
            maximumAmount: 12, 
            isActive: true, 
            idCategory: cannedCategory.id
    ...
    const inventories = products.map((product) => ({
        ...
        expirationDate: expirationDates[Math.floor(Math.random() * expirationDates.length)]
    }));
